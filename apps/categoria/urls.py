...
from .views import CreateCategoria, GetAllCategorias, GetCategoria, UpdateCategoria, DeactivateCategoria,DeleteCategoria
...
urlpatterns = [
    ...
    path('categorias/delete/<int:id>/', DeleteCategoria.as_view(), name='delete-categoria'),
]
